  ...
  return isLoading ? (
    ...
    <div className="relative flex flex-col">
      <div className="flex">
        ...
        <div className={isCheckingOut ? "w-1/2 p-5" : "w-full p-5"}>
          <div className="relative flex flex-col">
            ...
            <div className="w-9/12 mx-auto p-5 max-w-lg border-solid border-black">
              ...
              {!isCheckingOut && (
                <>
                  <button
                    className="float-left mt-4 inline font-semibold bg-gray-500 hover:bg-gray-700 text-white px-2 pb-1 rounded-full"
                    onClick={() => clearCart()}
                  >
                    Clear Cart
                  </button>
