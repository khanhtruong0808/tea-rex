          ...
          <div className="mx-auto max-w-7xl px-2 lg:px-5 xl:px-8">
            <div className="flex h-16 md:h-20 xl:h-24 items-center justify-between">
              ...
              <div className="-mr-2 flex md:hidden">
                {/* Mobile menu button */}
                <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md p-2 text-black hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
